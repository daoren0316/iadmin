...
public class KdtApiProtocol
{
  ...
  public static String sign(String appSecret, HashMap<String, String> params)
  {
    ...
    for (String key : keyList) {
      signContent = signContent + key + (String)params.get(key);
    }
    signContent = signContent + appSecret;
