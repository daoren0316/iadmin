...
<div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="<%=basePath%>site/activity_toIndex.do"
          method="post">
...
<div class="pageContent">
    ...
    <table class="table" width="100%" layoutH="138">
        ...
        <c:if test="${!empty activityList}">
            <c:forEach items="${activityList}" var="al" varStatus="sort">
                <tr target="sid_user" rel="${al.activityId }">
                    <td>${((page.currentPage-1) * numPerPage)+sort.count }</td>
                    <td>${al.activityTitle}</td>
