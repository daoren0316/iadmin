...
<div class="pageContent">
    <form method="post" action="<%=basePath%>site/activity_update.do" class="pageForm required-validate"
        ...
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>
                <dt>活动图片：</dt>
                <dd>
                    <div id="uppActivityAttachPanel" class="divPanel">
                        <span><input type="file" name="image"/></span></div>

                    <div class="divPanel">
                        <a href="javascript:;" onclick="_addFile('uppActivity')" title="添加">
                            <img src="<%=basePath%>images/file_add.png"/></a>
                        <a href="javascript:;" onclick="_delFile('uppActivity')" title="删除">
            ...
            <dl>
                <dt>活动描述：</dt>
                <dd>
                    <textarea name="activityDesc" cols="80" rows="15">${activity.activityDesc}</textarea>
                </dd>
            </dl>
        </div>
        <div class="formBar">
