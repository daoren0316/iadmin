...
<div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="<%=basePath%>site/feedback_toBxIndex.do"
          method="post">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select style="float: none" class="combox" name="type">
                            ...
                            <option value="1" <c:if test="${type eq 1}">selected="selected"</c:if>>公司保修</option>
                            <option value="2" <c:if test="${type eq 2}">selected="selected"</c:if>>个人保修</option>
                        </select>
                    </td>
                    <td>
        ...
        <c:if test="${!empty feedbackList}">
            <c:forEach items="${feedbackList}" var="al" varStatus="sort">
                <tr target="sid_user" rel="${al.feedbackId }">
                    ...
                    <td style="color: ${al.type eq 1 ? 'blue' : 'purple'}">${al.type eq 1 ? '公司保修' : '个人保修'}</td>
