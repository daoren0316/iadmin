...
%>
<h2 class="contentTitle">修改绑定POS机信息</h2>

<div class="pageContent">
    <form method="post" action="<%=basePath%>site/pos_update.do" class="pageForm required-validate"
            ...
            <dl>
                ...
                <dd>
                    <input type="text" name="posNo" class="required digits" size="25"
                           value="${pos.posNo}" readonly="readonly"/>
                </dd>
            </dl>
                ...
                <dd>
                    ...
                    <div class="divPanel1">
                        <a class="btnLook" href="<%=basePath%>site/pos_lookupShop.do" maxable="false"
                           rel="upp_lookupShop" width="750" height="500"
