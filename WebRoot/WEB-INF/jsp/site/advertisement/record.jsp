...
<div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="<%=basePath%>site/advertisement_toIndex.do"
          method="post">
        ...
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    <td>
                        链接地址
                        <input type="text" name="picUrl" value="${picUrl}" size="30"/>
                    </td>
...
<div class="pageContent">
    ...
    <table class="table" width="100%" layoutH="138">
        ...
        <c:if test="${!empty advertiseList}">
            <c:forEach items="${advertiseList}" var="al" varStatus="sort">
                <tr target="sid_user" rel="${al.advId }">
        ...
        <c:if test="${empty advertiseList}">
            <tr>
                <td colspan="2" align="center">没有您需要的数据</td>
            </tr>
        </c:if>
        </tbody>
    </table>
