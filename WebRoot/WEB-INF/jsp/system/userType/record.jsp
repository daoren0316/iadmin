...
<div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="<%=basePath%>admin/type_toIndex.do"
          method="post">
...
<div class="pageContent">
    ...
    <table class="table" width="100%" layoutH="138">
        ...
        <tr>
            <th width="80">序列号</th>
            <th>类型名称</th>
            <th width="120">类型标识</th>
        </tr>
        </thead>
        <tbody>
        <c:if test="${!empty userTypeList}">
            <c:forEach items="${userTypeList}" var="utl" varStatus="sort">
                <tr target="sid_user" rel="${utl.typeId }">
