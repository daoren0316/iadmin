...
<div class="menu">
	<ul id="leftmenu">
		<li><a href="<s:url value="/site/charge_add.do"/>" target="main">线下充值</a></li>
		<li><a href="<s:url value="/admin/activity_doActivityList.do"/>" target="main">活动管理</a></li>
		<li><a href="<s:url value="/site/commodity_doCommodityList.do"/>" target="main">团购管理</a></li>
		<li><a href="<s:url value="/site/order_doList.do"/>" target="main">订单管理</a></li>
		<li><a href="<s:url value="/site/feedback_doList.do"/>" target="main">投诉报修</a></li>
		<li><a href="<s:url value="/site/message_doList.do"/>" target="main">查看留言</a></li>
		<li><a href="<s:url value="/site/profile_edit.do"/>" target="main">修改服务小站信息</a></li>
